...
export default function GameCard(props) {
    ...
    return (
        <section
            className="w-80 h-90 flex flex-col m-auto items-center justify-evenly border-4 rounded-lg bg-orange-300 border-orange-500 text-black p-4 shadow-lg relative"
