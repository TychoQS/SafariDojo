...
export default function GameOverModal({ onCloseMessage, onRestart }) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center backdrop-blur-sm bg-white/20">
            <div
                className="p-6 rounded-xl w-3/4 max-w-lg text-center bg-amber-50 shadow-xl transform transition-all text-red-600 scale-110"
            >
                <h2 className="text-3xl font-extrabold mb-2">
                    💀 {t("gameOver")}
                </h2>
                <p className="text-lg mb-4"> {t("gameOverMessage")} </p>
