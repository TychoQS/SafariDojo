const Footer = () => {
    return (
        <footer className="flex flex-col items-center text-center p-4 shadow-md bg-white w-[80rem] h-[6rem]">
            <div className="flex justify-center items-center gap-10 w-full">
                ...
                <ul className="flex gap-4 list-none p-0 m-0 items-center">
                    <li>
                        <a className="text-black transition-all duration-300 ease-in-out hover:text-orange-300 hover:scale-110" href="#">Privacy Policy</a>
                    </li>
                    <li>
                        <hr className="border-0 w-[1.5px] h-3 bg-black" />
                    </li>
                    <li>
                        <a className="text-black transition-all duration-300 ease-in-out hover:text-orange-300 hover:scale-110" href="mailto:ayman.asbai101@alu.ulpgc.es">Contact</a>
                    </li>
                </ul>
            </div>
